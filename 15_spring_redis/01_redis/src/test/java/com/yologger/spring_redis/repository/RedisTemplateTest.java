...
//        String saved = (String) operation.get(key);
//
//        assertThat(saved).isEqualTo(value);


        String key = "phone";
        Phone p = new Phone("iPhone 3");
        ValueOperations<String, Phone> operation = redisTemplate.opsForValue();
        operation.set(key, p);

        Phone saved = operation.get(key);
        assertThat(saved.getName()).isEqualTo("iPhone 3");
...
//
//        String key = "person";
//        ListOperations<String, Object> operation = myRedisTemplate.opsForList();
//        operation.rightPush(key, "Paul");
//        operation.rightPushAll(key, "Smith", "Jane", "Eric");
//        List<String> people = operation.range(key, 0, -1);
...
//
//        // Set에 요소 하나 추가
//        operations.add(key, "Paul");
//
//        // Set에 요소 여러 개 추가
//        operations.add(key, "Smith", "Jane", "Eric");
//
//        // Set 조회
//        Set<String> people = operations.members(key);
//
//        assertThat(people.size()).isEqualTo(4);
...
//
//        operation.put(key, "name", "paul");
//        operation.put(key, "email", "paul@gmail.com");
//        operation.put(key, "password", "1234");
//
//        Map<String, String> person = operation.entries(key);
//
